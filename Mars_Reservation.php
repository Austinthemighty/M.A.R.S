...
<br>
    ...
    <br>
<a href="images/marsmap.jpg">Look at map</a> <!--Link to look at a latitude longitude map of mars-->
    <p>Location:</p><p>Latitude: <input type="number" name="Location">  Longitude: <input type="number" name="Location"></p><!--ware you enter the location of your reservation-->
    <p>Reservation Date:</p><p> Start:<input type="date" name="Start date"> Return:<input type="date" name="End date"></p> <!--ware you enter the date of your reservation-->
    <br>
    <br>
